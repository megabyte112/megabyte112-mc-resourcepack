...
- Ore Borders that glow and connect to each other
...
Make sure either [OptiFine](https://optifine.net/) or [Continuity](https://github.com/PepperCode1/Continuity) are installed for connected and emissive textures.


UPDATING:

You can get the auto updater from [here](https://github.com/megabyte112/megabyte112-RP-updater/releases).
